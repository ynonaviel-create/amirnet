...
function finishRun() {
  ...
  if (est) h += '<div class="note" style="text-align:center">קצב של <b>' + est +
    '</b> בסולם 50–150' + (den < 23 ? ' — משוקלל על הפרקים שעשית בלבד' : '') + '</div>';
...
async function view(v) {
  ...
  note.appendChild(el('p', 'note',
    '<b>השעון.</b> מאל"ו לא מפרסמת זמן לכל פרק, רק 39 דקות לכלל המבחן על 7–8 פרקים ' +
    'שמתוכם 1–2 ניסוייים. ההקצבה כאן נגזרה מעומס הקריאה שמדדתי — 1:24 לשאלה כבסיס, ' +
