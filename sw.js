...
const V = 'amirnet-lomda-1';
const SHELL = [
  './', './index.html', './manifest.webmanifest',
  './assets/style.css', './assets/tokens.css',
  './assets/app.js', './assets/lomda.js', './assets/today.js', './assets/print.js', './assets/progress.js', './assets/exam.js', './assets/words.js', './assets/about.js', './assets/onboard.js', './assets/strategy.js', './assets/drills.js', './assets/cloud.js', './assets/vendor/supabase.js',
