...
const V = 'amirnet-9925f7b0';
const SHELL = [
  './', './index.html', './manifest.webmanifest',
  './assets/style.css', './assets/tokens.css',
  './assets/app.js', './assets/today.js', './assets/print.js', './assets/progress.js', './assets/exam.js', './assets/words.js', './assets/onboard.js', './assets/strategy.js', './assets/drills.js', './assets/cloud.js', './assets/vendor/supabase.js',
