...
const V = 'amirnet-4deb16ff';
const SHELL = [
  './', './index.html', './manifest.webmanifest',
  './assets/style.css', './assets/tokens.css', './assets/components.css',
  './assets/app.js', './assets/today.js', './assets/print.js', './assets/progress.js', './assets/strategy.js', './assets/drills.js', './assets/cloud.js', './assets/vendor/supabase.js',
